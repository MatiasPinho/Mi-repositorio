---
name: estudiar
description: Inicia una sesión adaptativa según progreso, repasos y evaluaciones.
argument-hint: "[materia] [minutos opcionales]"
disable-model-invocation: true
---
# Acción portable: estudiar
...
3. Ejecutá exactamente `../../../pipelines/estudiar.md`.

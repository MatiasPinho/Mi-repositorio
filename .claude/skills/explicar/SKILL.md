---
name: explicar
description: Explica profundamente un concepto usando la materia como base.
argument-hint: "[materia] [concepto]"
disable-model-invocation: true
---
# Acción portable: explicar
...
3. Ejecutá exactamente `../../../pipelines/explicar.md`.

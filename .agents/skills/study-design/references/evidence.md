...
- WCAG 2.2 describes mechanisms for readable line length, non-justified text, 1.5 line spacing and robust text resizing. https://www.w3.org/TR/WCAG22/
- GOV.UK's current type scale uses 19px for standard body text and a consistent vertical rhythm, after iterative readability/accessibility work. https://design-system.service.gov.uk/styles/type-scale/

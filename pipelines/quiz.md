...
14. Finish with `python scripts/venv_exec.py scripts/quiz_run.py finish --run <run-dir>`. Finish rejects a changed canonical snapshot, an invalid review chain, failed integrity/interaction/visual gates, publication mismatch or engine mutation.
